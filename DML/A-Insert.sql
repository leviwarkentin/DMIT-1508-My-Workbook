...
/*  Notes:
	...
	When inserting values, you can use a subqueries for individual values
	provided that the subquery returns a single value:

	INSERT INTO TableName(Comma, Seperated, ListOf, ColumnNames)
	VALUES ('A', (SELECT SignleValue FROM SomeTable), 'Per', 'Column')
...
VALUES ('Katrina', 'White', 'f', '5074 E Center St', 'LLB', 'AB', 'T0A2C1', 'Jan 5, 1943')
SELECT * FROM Student
